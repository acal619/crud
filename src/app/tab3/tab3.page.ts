...
export class Tab3Page {
  ...
  async getData() {
    ...
    try {
      const res = await axios.post('http://localhost:8080/api-crud/api/get_data_mahasiswaId.php', fd);
  ...
  async updateData() {
    ...
    try {
      const res = await axios.post('http://localhost:8080/api-crud/api/update_data_mahasiswa.php', fd);
